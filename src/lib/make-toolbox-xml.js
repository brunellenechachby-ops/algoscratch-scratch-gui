...
const getAlgoScratchActivity = function () {
...
const isAlgoScratchSimpleMode = function () {
...
const simpleAlgoScratchToolbox = function (isStage, targetId, colors) {
    ...
    return [
        xmlOpen,
        `
    <category name="%{BKY_CATEGORY_EVENTS}" id="events" colour="${colors.event.primary}" secondaryColour="${colors.event.tertiary}">
        <block type="event_whenflagclicked"/>
    </category>`,
        categorySeparator,
        `
...
const makeToolboxXML = function (isInitialSetup, isStage = true, targetId, categoriesXML = [],
    ...
    if (isAlgoScratchSimpleMode()) {
        return simpleAlgoScratchToolbox(isStage, targetId, colors);
    }
